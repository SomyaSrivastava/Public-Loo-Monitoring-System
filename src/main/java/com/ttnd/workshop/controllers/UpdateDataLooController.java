...
/**
 * Servlet implementation class UpdateDataLooController
 */
public class UpdateDataLooController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateDataLooController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id=Integer.valueOf(request.getParameter("lid"));//null
			...
			loo.setState(state);
			out.print("update data controller id + "+id);
			loo.setId(id);
